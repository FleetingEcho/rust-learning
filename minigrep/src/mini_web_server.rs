...
use async_std::io::{Read, Write, Result as AsyncResult};
use std::cmp::min;
use std::pin::Pin;
...
async fn test_handle_connection() {
    ...
    let expected_contents = async_std::fs::read_to_string("src/hello.html").await.unwrap();
    let expected_response = format!("HTTP/1.1 200 OK\r\n{}", expected_contents);
    println!("Expected Response:\n{}", expected_response);
    println!("Actual Write Data:\n{}", String::from_utf8_lossy(&stream.write_data));
